...
ENV DEVEL_KIT_MODULE_VERSION 0.3.2
...
RUN sed -i 's/dl-cdn.alpinelinux.org/mirrors.aliyun.com/g' /etc/apk/repositories && \
	...
	apk add --no-cache tzdata gnu-libiconv
...
#  && install -m755 objs/ngx_http_geoip2_module.so /usr/lib/nginx/modules/ngx_http_geoip2_module.so \
...
COPY geoip/GeoLite2-City.mmdb /etc/nginx/geoip/GeoLite2-City.mmdb
